...
<script type="text/javascript">
	...
	/** 模糊查询来电用户  **/
	function search(){
		$("#submitForm").attr("action", "deal/find.action?pageNum=" + 1).submit();
	}
...
// 				return;
	...
	function jumpNormalPage(page){
		$("#submitForm").attr("action", "deal/find.action?pageNum=" + page).submit();
	}
					...
					<div id="box_border">
						...
						<div id="box_center">
							...
							<select name="query" id="fyXq" class="ui_select01" ">
                                ...
                                <option value="1" <c:if test="${query eq 1}">selected="selected"</c:if>>交易记录编号</option>
                                <option value="2" <c:if test="${query eq 2}">selected="selected"</c:if>>客户编号</option>
                                <option value="3" <c:if test="${query  eq 3}">selected="selected"</c:if>>销售人员工号</option>
                            </select>
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<c:forEach items="${deals}" var="d">	
							<tr>
								...
								<td>${d.dnId}</td>
								<td>${d.dnCustomerId}</td>
								<td>${d.employeeid}</td>
								<td>${d.dnDate}</td>
								<td>${d.dnBeginPrice}</td>
								<td>${d.dnEndPrice}</td>
								<td>${d.applyid}</td>
								<td>${d.dnDescription}</td>
							</tr>
						</c:forEach>
					</table>
				</div>
